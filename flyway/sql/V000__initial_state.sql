CREATE DATABASE IF NOT EXISTS sistema_tcc DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE sistema_tcc;
CREATE TABLE aluno (id INT AUTO_INCREMENT NOT NULL, pessoa_id INT DEFAULT NULL, matricula VARCHAR(10) NOT NULL, cgu VARCHAR(11) NOT NULL, INDEX fk_aluno_pessoa1_idx (pessoa_id), UNIQUE INDEX matricula_UNIQUE (matricula), UNIQUE INDEX cgu_UNIQUE (cgu), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
